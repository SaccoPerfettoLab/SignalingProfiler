...
Since the **PKN** contains interactions coming from different experimental systems, a good practice is to keep only the interactions involving analytes expressed in your system, so quantified in at least one of your omics data set.
...
You can work with the whole organism-specific PKN tables, otherwise (`PKN_mouse`, `PKN_human`).
