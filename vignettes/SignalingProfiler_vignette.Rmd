...
<img src="./img/SP_package_workflow_TUTORIAL.png" align="center"/>
...
Signaling Profiler allow you to use built-in PKNs for **mouse** and **human** or to exploit a **custom PKN.**
For the custom PKN you have to provide the path of the file and this allow you to use old version of PKNs, available in the PKN_old_release folder of our GitHub page. 
...
If you set `report=TRUE`, a report file is written in your working directory.
If you are using the human PKN extended with atlas interactions, set `with_atlas=TRUE`.

```{r eval = FALSE}
coverage_of_inferred_proteins_in_db(toy_prot_activity_df, organism = 'mouse', 
                                    with_atlas = FALSE, report = FALSE) 
```
